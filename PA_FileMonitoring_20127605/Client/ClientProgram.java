...
import FileManipulation.FileBrowser;
import FileManipulation.FileWatcher;
...
public class ClientProgram {
    ...
    public void Connect() throws IOException {
        ...
        while (isConnecting) {
            ...
            if (receivedString.equals("DISCONNECT")) {
                ...
                try {
                    watcher = new FileWatcher(Paths.get(receivedString));
                        ...
                        public void run() {
                            ...
                            while (isConnecting) {
                                try {
                                    ...
                                    System.out.println(watcher.getWatcherMessage());
                    ...
                    String msg = String.format("AccessDeniedException: Try monitoring another directory from %s!",this.clientName);
                    dos.writeUTF("INFO");
                    dos.writeUTF(msg);
                }
            }
    ...
    public void sendDirectoryTree() throws IOException {
        this.treeDirectory = new FileBrowser().getTree();
        this.dos.writeUTF("INFO");
    ...
    private static void createAndShowGUI() {
        ...
        ClientProgram clientprog = new ClientProgram();
